...
struct FlockConfig : interfaces::module::ISystemConfig
{
    ...
    f32 perceptionRadius = 30.0f;
    f32 separationRadius = 30.0f;
    f32 separationWeight = 5.0f;
    f32 alignmentWeight = 2.0f;
    f32 cohesionWeight = 1.0f;
    std::size_t maxNeighbours = 24;
...
{
public:
    Flock(simulation::world::World& world, const FlockConfig& config = FlockConfig{});
    ~Flock() override;
